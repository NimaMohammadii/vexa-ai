...
import { TelegramBotFlowService, type TelegramWebhookUpdate } from "../services/telegram-active-bot-service";
import { UserStateRepository } from "../storage/user-state-repository";
import type { RouteCtx } from "./types";

export async function handleTelegramActiveRoutes(ctx: RouteCtx): Promise<Response | null> {
