...
ASK_CLONE_TTS = "🎙 متن را برای ساخت خروجی با صدای انتخاب‌شده بفرستید."
STATE_CLONE_TTS = "ADMIN:CLONE:TTS"
...
# ——— تنظیمات: دموهای صدا
ASK_DEMO_LANG = "🎧 زبان دمو را انتخاب کنید."
ASK_DEMO_VOICE = "🎧 یک صدا را برای ثبت دمو انتخاب کنید."
ASK_DEMO_AUDIO = "🎧 فایل صوتی دمو را ارسال کنید (audio/voice/document).\nیا اگر خواستید دمو را حذف کنید، از دکمه حذف استفاده کنید."
STATE_DEMO_AUDIO = "ADMIN:DEMO:AUDIO"

# ——— تنظیمات: پیام صوتی خوش‌آمد
ASK_WELCOME_AUDIO_LANG = "🎙 زبان پیام صوتی خوش‌آمد را انتخاب کنید."
ASK_WELCOME_AUDIO = "🎙 فایل صوتی خوش‌آمد را ارسال کنید (audio/voice/document).\nیا اگر خواستید حذفش کنید، از دکمه حذف استفاده کنید."
STATE_WELCOME_AUDIO = "ADMIN:WELCOME:AUDIO"
