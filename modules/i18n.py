...
LABELS.update({
    ...
    "gpt_reset": {
        "fa": "✅ چت قبلی پاک شد. یک پیام جدید بفرست.",
        "en": "✅ Conversation cleared. Send a new message.",
        "ar": "✅ تم مسح المحادثة. أرسل رسالة جديدة.",
        "tr": "✅ Sohbet temizlendi. Yeni bir mesaj gönder.",
        "ru": "✅ История очищена. Отправьте новое сообщение.",
        "es": "✅ Conversación borrada. Envía un nuevo mensaje.",
        "de": "✅ Unterhaltung gelöscht. Sende eine neue Nachricht.",
        "fr": "✅ Conversation effacée. Envoie un nouveau message.",
    },
    "gpt_reset_toast": {
        "fa": "چت جدید آماده شد",
        "en": "New chat ready",
        "ar": "تم تجهيز محادثة جديدة",
        "tr": "Yeni sohbet hazır",
        "ru": "Новый чат готов",
        "es": "Nuevo chat listo",
        "de": "Neuer Chat bereit",
        "fr": "Nouveau chat prêt",
    },
    "gpt_end": {
        "fa": "✅ گفت‌وگو با GPT پایان یافت.",
        "en": "✅ GPT chat ended.",
        "ar": "✅ انتهت محادثة GPT.",
        "tr": "✅ GPT sohbeti sona erdi.",
        "ru": "✅ Чат с GPT завершён.",
        "es": "✅ Chat con GPT finalizado.",
        "de": "✅ GPT-Chat beendet.",
        "fr": "✅ Discussion GPT terminée.",
    },
    "gpt_error": {
        "fa": "⚠️ خطا: {error}",
        "en": "⚠️ Error: {error}",
    ...
    "gpt_empty": {
        "fa": "🤖 پاسخی از GPT دریافت نشد.",
        "en": "🤖 No response from GPT.",
        "ar": "🤖 لم يتم تلقي رد من GPT.",
        "tr": "🤖 GPT'den yanıt gelmedi.",
        "ru": "🤖 Ответ от GPT не получен.",
        "es": "🤖 No se recibió respuesta de GPT.",
        "de": "🤖 Keine Antwort von GPT.",
        "fr": "🤖 Aucune réponse de GPT.",
    },
    "gpt_not_configured": {
        "fa": "⚠️ سرویس GPT در حال حاضر فعال نیست.",
        "en": "⚠️ GPT service is not configured.",
        "ar": "⚠️ خدمة GPT غير مهيأة حالياً.",
        "tr": "⚠️ GPT servisi yapılandırılmamış.",
        "ru": "⚠️ Сервис GPT не настроен.",
        "es": "⚠️ El servicio GPT no está configurado.",
        "de": "⚠️ GPT-Dienst ist nicht konfiguriert.",
        "fr": "⚠️ Le service GPT n'est pas configuré.",
    },
    "gpt_not_configured_alert": {
        "fa": "سرویس GPT فعال نیست.",
        "en": "GPT is not configured.",
        "ar": "خدمة GPT غير مهيأة.",
        "tr": "GPT yapılandırılmadı.",
        "ru": "GPT не настроен.",
        "es": "GPT no está configurado.",
        "de": "GPT ist nicht konfiguriert.",
        "fr": "GPT n'est pas configuré.",
    },
    "gpt_search_prompt": {
        "fa": "🔍 عبارت جستجو را بفرست. هر پیام {cost} کردیت از موجودی کم می‌کند.",
        "en": "🔍 Send the search query. Each message costs {cost} credits.",
        "ar": "🔍 أرسل عبارة البحث. كل رسالة تكلّف {cost} رصيدًا.",
        "tr": "🔍 Arama sorgusunu gönder. Her mesaj {cost} krediye mal olur.",
        "ru": "🔍 Отправьте поисковый запрос. Каждое сообщение стоит {cost} кредитов.",
        "es": "🔍 Envía la consulta de búsqueda. Cada mensaje cuesta {cost} créditos.",
        "de": "🔍 Sende deine Suchanfrage. Jede Nachricht kostet {cost} Guthaben.",
        "fr": "🔍 Envoie ta requête de recherche. Chaque message coûte {cost} crédits.",
    },
    "gpt_search_no_results": {
        "fa": "🔎 نتیجه مرتبطی پیدا نشد.",
        "en": "🔎 No relevant results found.",
        "ar": "🔎 لم يتم العثور على نتائج ذات صلة.",
        "tr": "🔎 İlgili sonuç bulunamadı.",
        "ru": "🔎 Ничего подходящего не найдено.",
        "es": "🔎 No se encontraron resultados relevantes.",
        "de": "🔎 Keine relevanten Ergebnisse gefunden.",
        "fr": "🔎 Aucun résultat pertinent trouvé.",
    },
    "gpt_no_credit": {
        "fa": "⚠️ موجودی کافی نیست. هر پیام {cost} کردیت هزینه دارد. موجودی فعلی: {balance} کردیت.",
        "en": "⚠️ Not enough credits. Each message costs {cost} credits. Current balance: {balance}.",
        "ar": "⚠️ الرصيد غير كافٍ. كل رسالة تكلّف {cost} رصيدًا. الرصيد الحالي: {balance}.",
        "tr": "⚠️ Yetersiz kredi. Her mesaj {cost} kredi. Güncel bakiye: {balance}.",
        "ru": "⚠️ Недостаточно кредитов. Каждое сообщение стоит {cost} кредитов. Текущий баланс: {balance}.",
        "es": "⚠️ Créditos insuficientes. Cada mensaje cuesta {cost} créditos. Saldo actual: {balance}.",
        "de": "⚠️ Nicht genug Guthaben. Jede Nachricht kostet {cost} Guthaben. Aktueller Stand: {balance}.",
        "fr": "⚠️ Crédits insuffisants. Chaque message coûte {cost} crédits. Solde actuel : {balance}.",
    },
    "back": {
        "fa": "🔙 بازگشت",
        "en": "🔙 Back",
