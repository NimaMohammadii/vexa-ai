...
LABELS.update({
    "gpt_open": {
        "fa": "🤖 <b>سلام، آماده‌ام؛ هرچی تو ذهنت هست بفرست تا با هم یه کم شیطنت کنیم.</b>\n💳 <b>هزینه هر پیام: {cost} کردیت</b>\n🕵️‍♀️ <b>برای جست‌وجوی وب از /websearch استفاده کن.</b>",
        "en": "🤖 <b>Hey, I'm ready—drop whatever's on your mind and let's stir things up.</b>\n💳 <b>Cost per message: {cost} credits</b>\n🕵️‍♀️ <b>Use /websearch whenever you want me to scout the web.</b>",
        "ar": "🤖 <b>مرحباً، أنا جاهز؛ أرسل ما تفكر به ولنحرك الأجواء قليلاً.</b>\n💳 <b>تكلفة كل رسالة: {cost} رصيداً</b>\n🕵️‍♀️ <b>استخدم /websearch عندما تحتاج بحثاً في الويب.</b>",
        "tr": "🤖 <b>Selam, hazırım; aklından geçeni yaz birlikte ortalığı hareketlendirelim.</b>\n💳 <b>Her mesajın ücreti: {cost} kredi</b>\n🕵️‍♀️ <b>Web araması için /websearch kullan.</b>",
        "ru": "🤖 <b>Привет, я наготове — делись мыслями, немного пошалим.</b>\n💳 <b>Стоимость сообщения: {cost} кредитов</b>\n🕵️‍♀️ <b>Для веб-поиска отправь /websearch.</b>",
        "es": "🤖 <b>¡Hola, listo para empezar! Cuéntame lo que pienses y agitamos la charla.</b>\n💳 <b>Cada mensaje cuesta {cost} créditos</b>\n🕵️‍♀️ <b>Usa /websearch cuando quieras que investigue en la web.</b>",
        "de": "🤖 <b>Hi, ich bin bereit – sag, was dir im Kopf herumspukt, und wir wirbeln ein wenig Staub auf.</b>\n💳 <b>Kosten pro Nachricht: {cost} Guthaben</b>\n🕵️‍♀️ <b>Nutze /websearch, wenn ich für dich das Web durchforsten soll.</b>",
        "fr": "🤖 <b>Salut, je suis prêt ; dis-moi ce qui te trotte en tête et mettons un peu d'ambiance.</b>\n💳 <b>Coût par message : {cost} crédits</b>\n🕵️‍♀️ <b>Utilise /websearch quand tu veux que j'explore le web.</b>",
    },
    "gpt_wait": {
        "fa": "⌛️ <b>یه لحظه صبر کن، دارم جواب رو با یه ذره شیطنت ردیف می‌کنم...</b>",
        "en": "⌛️ <b>Hang tight, brewing a cheeky answer...</b>",
        "ar": "⌛️ <b>لحظة واحدة، أحضّر لك جواباً فيه لمسة مشاكسة...</b>",
        "tr": "⌛️ <b>Az bekle, hafif yaramaz bir cevap demliyorum...</b>",
        "ru": "⌛️ <b>Секундочку, готовлю ответ с ноткой озорства...</b>",
        ...
        "tr": "🤖 <b>Selam! Ben neşeli GPT-5 yardımcıyım, aklına geleni yaz sohbet edelim.</b>\n💳 <b>Her mesajın ücreti: {cost} kredi</b>\n🕵️‍♀️ <b>Web araması için /websearch kullan.</b>",
        "ru": "🤖 <b>Привет! Я озорной помощник GPT-5 — делись мыслями, поболтаем.</b>\n💳 <b>Стоимость сообщения: {cost} кредитов</b>\n🕵️‍♀️ <b>Для веб-поиска отправь /websearch.</b>",
        "es": "🤖 <b>¡Hola! Soy el GPT-5 más divertido, cuéntame lo que pienses y charlemos.</b>\n💳 <b>Cada mensaje cuesta {cost} créditos</b>\n🕵️‍♀️ <b>Usa /websearch cuando necesites buscar en la web.</b>",
        "de": "🤖 <b>Hi! Ich bin dein humorvoller GPT-5 Sidekick – sag, was dir einfällt, und lass uns plaudern.</b>\n💳 <b>Kosten pro Nachricht: {cost} Guthaben</b>\n🕵️‍♀️ <b>Nutze /websearch für eine Websuche.</b>",
        "fr": "🤖 <b>Salut ! Je suis le GPT-5 espiègle, dis-moi ce qui te passe par la tête et papotons.</b>\n💳 <b>Coût par message : {cost} crédits</b>\n🕵️‍♀️ <b>Utilise /websearch pour lancer une recherche web.</b>",
    },
    "gpt_wait": {
        "fa": "⌛️ <b>یه لحظه صبر کن تا یه جواب خفن آماده کنم...</b>",
        "en": "⌛️ <b>Hold on, cooking up a witty answer...</b>",
        "ar": "⌛️ <b>لحظة واحدة، أجهّز لك ردّاً ظريفاً...</b>",
        "tr": "⌛️ <b>Dur bir nefes, eğlenceli cevabım geliyor...</b>",
        "ru": "⌛️ <b>Секундочку, придумываю шутливый ответ...</b>",
        "es": "⌛️ <b>Dame un segundo, preparo una respuesta con chispa...</b>",
        "de": "⌛️ <b>Einen Moment, ich zaubere eine witzige Antwort...</b>",
        "fr": "⌛️ <b>Une seconde, je mijote une réponse pleine d'esprit...</b>",
    },
    "gpt_new_chat": {
        "fa": "♻️ شروع چت جدید",
        "en": "♻️ New chat",
    ...
    "gpt_search_prompt": {
        "fa": "🔍 <b>/websearch فعاله! فقط بگو دنبال چی بگردم؛ هر پیام {cost} کردیت حساب میشه.</b>",
        "en": "🔍 <b>/websearch is live! Tell me what to chase—each message costs {cost} credits.</b>",
        "ar": "🔍 <b>أمر /websearch جاهز! أخبرني عمّا أبحث؛ كل رسالة تكلف {cost} رصيداً.</b>",
        "tr": "🔍 <b>/websearch hazır! Ne kovalayayım söyle; her mesaj {cost} kredi.</b>",
        "ru": "🔍 <b>/websearch активен! Скажи, что преследовать; каждое сообщение стоит {cost} кредита.</b>",
        "es": "🔍 <b>/websearch activo. Dime qué rastrear; cada mensaje cuesta {cost} créditos.</b>",
        "de": "🔍 <b>/websearch ist bereit! Sag mir, was ich aufstöbern soll; jede Nachricht kostet {cost} Guthaben.</b>",
        "fr": "🔍 <b>/websearch est prêt ! Dis-moi ce que je dois traquer ; chaque message coûte {cost} crédits.</b>",
    },
    "gpt_search_error": {
        ...
        "tr": "🔍 <b>/websearch aktif! Ne arayayım söyle (her mesaj {cost} kredi).</b>",
        "ru": "🔍 <b>/websearch активирован! Скажи, что искать (каждое сообщение {cost} кредита).</b>",
        "es": "🔍 <b>/websearch activado. Dime qué busco (cada mensaje cuesta {cost} créditos).</b>",
        "de": "🔍 <b>/websearch aktiviert! Sag mir, wonach ich suchen soll (jede Nachricht {cost} Guthaben).</b>",
        "fr": "🔍 <b>/websearch activé ! Dis-moi ce que je dois chercher (chaque message coûte {cost} crédits).</b>",
    },
