...
LABELS = {
    ...
    "tts_prompt":     {"fa":"✍️ متن را بفرست (هر کاراکتر = ۱ کردیت)","en":"✍️ Send your text (each character = 1 credit)","ar":"✍️ أرسل النص (كل حرف = 1 رصيد)","tr":"✍️ Metni gönder (her karakter = 1 kredi)","ru":"✍️ Отправьте текст (каждый символ = 1 кредит)","es":"✍️ Envía tu texto (cada carácter = 1 crédito)","de":"✍️ Sende deinen Text (jedes Zeichen = 1 Kredit)","fr":"✍️ Envoie ton texte (chaque caractère = 1 crédit)"},
